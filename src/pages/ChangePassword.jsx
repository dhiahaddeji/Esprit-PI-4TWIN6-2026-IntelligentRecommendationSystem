  ...
  return (
    <div className="authPage">
      <div className="authCard">
        ...
        <div style={{ background: "#FEF6E4", border: "1px solid #DEB04E", borderRadius: 8, padding: "12px 16px", marginBottom: 20 }}>
          <p style={{ margin: 0, color: "#7A4A00", fontSize: 13 }}>
        ...
        {error && (
          <div style={{ background: "#FBE9E9", border: "1px solid #F28080", borderRadius: 8, padding: "10px 14px", marginBottom: 16, color: "#8B1A1A", fontSize: 13 }}>
            {error}
          </div>
        )}
        ...
        {[0, 1, 2, 3].map((i) => (
          <div
            ...
            style={{
              ...
              height: 4,
              borderRadius: 2,
              background: i < score ? colors[score - 1] : "#DDD7C8",
