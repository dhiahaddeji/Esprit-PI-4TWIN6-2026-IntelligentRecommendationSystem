...
const ROLE_COLORS = {
  ...
  MANAGER:    { bg: "#E8F5ED", color: "#145C2B", label: "Manager" },
...
function Avatar({ name, size = 36, role }) {
  const meta = ROLE_COLORS[role] || { bg: "#DDD7C8", color: "var(--text-2)" };
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
          {[
            ...
            <button key={t.v} onClick={() => { setType(t.v); setSelected([]); }} style={{
              ...
              background: type === t.v ? "#0B2D38" : "#E4E4F0",
        ...
        {type === "announcement" && (
          <div style={{
            ...
            background: "#FEF6E4", border: "1px solid #FEF6E4", fontSize: 12.5, color: "#7A4A00",
          }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  border: `1.5px solid ${isSelected ? "#1D7A91" : "#E4E4F0"}`,
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 11.5, color: "#7A4A00", marginTop: 2 }}>
            📅 {dateStr} à {timeStr}
          </div>
        </div>
        <div style={{
          fontSize: 11, fontWeight: 600, padding: "4px 10px",
          borderRadius: 999, background: "#7A4A00", color: "#fff",
          letterSpacing: "0.5px",
        }}>ANNONCE</div>
      </div>
      ...
      {canWrite && (
        <div style={{
          ...
          <div style={{
            ...
            background: "linear-gradient(135deg,#FEF6E4,#FEF6E4)",
            borderBottom: "1px solid #FEF6E4",
            fontSize: 12.5, fontWeight: 700, color: "#7A4A00",
          ...
          <div style={{
            ...
            {!canWrite && (
              <div style={{
                ...
                fontSize: 12.5, color: "#7A4A00", fontWeight: 600,
              }}>
          ...
          <div style={{ display: "flex", gap: 4, marginTop: 10 }}>
            {[
              ...
              <button key={t.val} onClick={() => setFilter(t.val)} style={{
                ...
                background: filter === t.val ? "#0B2D38" : "#E4E4F0",
