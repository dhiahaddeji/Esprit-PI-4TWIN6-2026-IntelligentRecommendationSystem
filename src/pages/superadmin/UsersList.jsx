...
const ROLE_COLORS = {
  ...
  HR: { bg: "#D6EEF3", color: "#1d4ed8" },
  MANAGER: { bg: "#FEF6E4", color: "#b45309" },
  EMPLOYEE: { bg: "#E8F5ED", color: "#145C2B" },
};

const STATUS_COLORS = {
  ACTIVE:    { bg: "#E8F5ED", color: "#145C2B" },
  INACTIVE:  { bg: "#E4E4F0", color: "var(--text-2)" },
        ...
        <div style={{
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              ...
              <tbody>
                {filtered.map((user, i) => {
                  const rc = ROLE_COLORS[user.role] || { bg: "#E4E4F0", color: "var(--text-2)" };
                  ...
                  return (
                    <tr key={user._id} style={{
                      borderBottom: i < filtered.length - 1 ? "1px solid #E4E4F0" : "none",
